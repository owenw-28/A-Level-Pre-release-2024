...
class Puzzle():
        ...
        while not Finished:
            ...
            while not Valid:
                try:
                    ...
                    if Row < self.__GridSize and Row >= 1:
                        Valid = True
                    else:
                        print(f"Not a valid row number, please type a number between 1 and {self.__GridSize}")
                except:
            ...
            while not Valid:
                try:
                    ...
                    if Column < self.__GridSize and Column >= 1:
                        Valid = True
                    else:
                        print(f"Not a valid column number, please type a number between 1 and {self.__GridSize}")
                except:
                    print("PLease enter a number")
    ...
    def __GetSymbolFromUser(self):
        ...
        while not Symbol in self.__AllowedSymbols:
            ...
            if Symbol not in self.__AllowedPatterns:
